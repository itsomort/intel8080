...
// testing rotation
const uint8_t rotation[12] = {0x3E, 0xF2, 0x07, 0x3E, 0xF2, 0x0F, 0x3E, 0xB5, 0x17, 0x3E, 0x6A, 0x1F};
// testing immediate arithmetic, as long as ADI works 
// don't need to check other logic because same as register/memory 
const uint8_t immarith[4] = {0x3E, 0x01, 0xC6, 0x04};